...
class DSRLineGraphicsMatplotlib:
    ...
    def plot_bbox_gnss_and_motion_qc_for_line_paged(
        ...
        gnss_pages = self.plot_bbox_gnss_qc_for_line_paged(
            line=line,
            common=common,
            hours_per_page=hours_per_page,
            pad_minutes=pad_minutes,
            save_dir=save_dir,
            file_prefix=gnss_file_prefix,
            ext=ext,
            dpi=dpi,
            figsize=figsize,
            is_show=is_show,
        ...
        motion_pages = self.plot_bbox_motion_qc_for_line_paged_combined(
            line=line,
            common=common,
            hours_per_page=hours_per_page,
            pad_minutes=pad_minutes,
            save_dir=save_dir,
            file_prefix=motion_file_prefix,
            ext=ext,
            dpi=dpi,
            figsize=figsize,
            is_show=is_show,
