...
class EOLReportGeneratorV2:
    ...
    def _normalize_layout(layout) -> list[dict]:
        titles = {
            "front_page": "Front Page", "table_of_contents": "Table of Contents",
            "line_summary": "Line Summary", "project_map": "Project Map",
            "dsr_info_table": "DSR Information", "deployment": "Deployment",
            ...
            "deployment_water_depth": "Deployment Water Depth", "bbox_qc": "Black Box QC",
            "bbox_qc_gnss": "Black Box GNSS QC", "bbox_qc_motion": "Black Box Motion QC",
            "deployment_vs_bbox": "Deployment vs Black Box", "source": "Source",
            "source_summary": "Source Summary", "recovery": "Recovery",
            "recovery_qc_package": "Recovery QC Package", "final_comparison": "Final Comparison",
            "comments": "Comments",
        }
        normalized = []
        for item in layout:
