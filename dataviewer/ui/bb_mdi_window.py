...
class BbMdiWindow(QtWidgets.QMainWindow):
    def __init__(self, parent=None):
        super().__init__(parent)

        self.setWindowTitle("BlackBox Time Series")
    ...
    def set_title(self, line: int):
        self.setWindowTitle(f"BlackBox Time Series - Line {line}")
